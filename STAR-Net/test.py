...
parser.add_argument("--noise_level", type=int, dest="noise_level", help="Should be an int in the range [0,255]", default=50)
parser.add_argument("--unfoldings", type=int, dest="unfoldings", help="Number of unfolded", default=9)
...
parser.add_argument("--lmbda_prox", type=float, default=0.02, help='')
parser.add_argument("--multi_theta", type=str2bool, default=1, help='')
parser.add_argument("--gpus", '--list',action='append', type=int, help='GPU', default=[0,1,2,3])
parser.add_argument("--beta_prox", type=float, default=0.02, help='')
...
#data
parser.add_argument("--model_name", type=str, dest="model_name", help="The name of the model to be saved.", default="/trained_model/ckpt")
parser.add_argument("--test_path", type=str, help="Path to the dir containing the testing datasets.", default="/test")
...
parser.add_argument("--gt_path", type=str, help="Path to the dir containing the ground truth datasets.", default="/test")
...
parser.add_argument("--test_batch", type=int, default=50, help='batch size of testing')
...
model=init_model(kernel_size=args.kernel_size,num_filters=args.num_filters,unfoldings=args.unfoldings,lmbda_prox=args.lmbda_prox,stride=args.stride,multi_theta=args.multi_theta,verbose=args.verbose, beta=args.beta_prox,l=args.l_prox, gamma_1=args.gamma_1, gamma_2=args.gamma_2)
